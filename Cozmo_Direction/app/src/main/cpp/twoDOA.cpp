...
//    N = n;
    ...
    twoDOA->corrtheta_est = theta_est;
    twoDOA->prevcorrtheta_est = theta_est;
...
//int twoDOAProcess(int16_t x, int16_t h, int32_t numFrames) {
...
//        }
        ...
        //clock_t t;
        //t = clock();  //For timing
//        twoDOA->doIT(twoDOA, x_frame, h_frame, win, i, twoDOA->prevmag_fft_Framex,
//                     twoDOA->prevmag_fft_Frameh, twoDOA->prevcorrtheta_est, twoDOA->SFxmax,
//                     twoDOA->SFxavg, twoDOA->flagSFx, mSampleRate, numFrames,
//                     NFFT);//TwomicDOA function estimates source location
//        //t = clock() - t;  //For timing
//
//        //printf("It took me %d clicks (%1.9g  seconds)\n", t, (float)t / CLOCKS_PER_SEC);
//        j = twoDOA->corrtheta_est;
//        return output;
//    }
//}
